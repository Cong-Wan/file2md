...
Version: 1.0
  Date: 2026-04-10
  Description: LaTeX 数学符号映射字典（来自 mineru/model/docx/tools/math/latex_dict.py）
'''

# ── LaTeX dict (from mineru/model/docx/tools/math/latex_dict.py) ─────────────
...
T = {
    ...
    "\u00c5": "\\rmsg ",  # Å LATIN CAPITAL LETTER A WITH RING — pylatexenc: \r{A} (text-mode only)
